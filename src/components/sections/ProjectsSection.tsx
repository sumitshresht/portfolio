...
export default function ProjectsSection() {
  const projects = [
    { name: "APIForge", desc: "Developer-focused API mocking platform simulating realistic backend behavior. Engineered with dynamic route registration and latency injection.", stack: ["Next.js", "Spring Boot", "Docker", "PostgreSQL"], image: "/api-forge.png", link: "https://apiforge-frontend.vercel.app/login", glow: "group-hover:shadow-[0_0_40px_rgba(245,158,11,0.15)] group-hover:border-amber-500/30", textHover: "group-hover:text-amber-400" },
    { name: "FlatDB", desc: "Lightweight open-source NoSQL database built using flat-file JSON storage. Architected for high-efficiency transactional IO.", stack: ["Java", "Gson", "JUnit"], image: "/flatDB.png", link: "https://mvnrepository.com/artifact/io.github.sumitshresht/FlatDB", glow: "group-hover:shadow-[0_0_40px_rgba(16,185,129,0.15)] group-hover:border-emerald-500/30", textHover: "group-hover:text-emerald-400" },
    { name: "SecureZip", desc: "Security-first encryption & compression library. High-performance standard-compliant Java data archiving optimized with AES protocols.", stack: ["Java", "AES", "SHA-256"], image: "/SecureZIP.png", link: "https://central.sonatype.com/artifact/io.github.sumitshresht/SecureZip", glow: "group-hover:shadow-[0_0_40px_rgba(139,92,246,0.15)] group-hover:border-purple-500/30", textHover: "group-hover:text-purple-400" },
    { name: "Saanjha", desc: "\"Where thoughts spark conversations.\" A modern, highly responsive social space engineered to handle seamless connections and relational data.", stack: ["React.js", "Spring Boot", "PostgreSQL"], image: "/saanjha.png", link: "https://saanjha-frontend.vercel.app/login", glow: "group-hover:shadow-[0_0_40px_rgba(20,184,166,0.15)] group-hover:border-teal-500/30", textHover: "group-hover:text-teal-400" }
  ];
